 ...
 *
 * <pre>
 *   racingAppDev = angular.module('racingAppDev', ['racingApp', 'ngMockE2E']);
 *   racingAppDev.run(function($httpBackend) {
...
window.jasmine && (function(window) {
   ...
   * <pre>
   *
   *   angular.module('racingApplicationModule', [])
   *       .value('mode', 'app')
   *       .value('version', 'v1.0.1');
   *
   *
   *   describe('racingApp', function() {
   *
   *     // You need to load modules that you want to test,
   *     // it loads only the "ng" module by default.
   *     beforeEach(module('racingApplicationModule'));
   *
   *
